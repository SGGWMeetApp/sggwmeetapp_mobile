...
class EventSelectGroupAdapter(groupList: ArrayList<GroupResponse>, activity: Activity): RecyclerView.Adapter<EventSelectGroupAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            ...
            val intent = Intent()
            intent.putExtra("groupId",model.id)
